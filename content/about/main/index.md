...
title: "Paul Hoffmann" # leave blank to exclude
number_featured: 1 # pulling from mainSections in config.toml
use_featured: false # if false, use most recent by date
number_categories: 3 # set to zero to exclude
show_intro: true
intro: |
  Hi, I'm Paul — a former banking student turned tech professional. After a banking apprenticeship, studying Business Administration in Regensburg and Banking & Finance in Innsbruck, I worked in software testing, requirements engineering, and product ownership.
